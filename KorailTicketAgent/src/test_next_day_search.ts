...
async function testNextDaySearch() {
  console.log('🧪 Testing Korail Search with Next Day Button...');
  ...
  try {
    ...
    // Departure default is 서울, select Arrival: 대전
    ...
    // Click "다음날" button
    console.log('Clicking Next Day (다음날) button on list page...');
    ...
    console.log('Clicked next day:', clickedNext);
    ...
    fs.writeFileSync('next_day_result.json', JSON.stringify(result, null, 2));
    console.log('Saved next_day_result.json');
